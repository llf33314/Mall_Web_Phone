      ...
      <div class="app-preview">
        <div class="app-entry">
          <div  class="clearfix" v-for="(data,index) in dataJson" :key="index">
            ...
            <grouping class="module pr" v-if="data.type == 16" :data="data" :_page="index" :pic-json="picJson[index]" v-scroll/>
...
.coupon-list {
  ...
  font-size: 0;
  color: #fff;
  background-image: url(/images/static/img/coupon_bg.edf0e91.png);
  display: inline-block;
  margin-right: 0.077625rem;
}
.coupon-list-t {
  padding: 0.646875rem 0.56925rem 0.207rem;
}
.coupon-list-t-l {
  width: 2.277rem;
  height: 2.277rem;
  border-radius: 0.181125rem;
  margin-right: 0.207rem;
}
.coupon-list-t-l,
.coupon-list-t-r {
  display: inline-block;
...
.coupon-list-t-r-name {
  font-size: 0.491625rem;
  line-height: 0.491625rem;
}
.coupon-list-t-r-price {
  font-size: 1.60425rem;
  line-height: 1.992375rem;
}
.coupon-list-t-r-price span {
  font-size: 0.802125rem;
  line-height: 0.802125rem;
}
.coupon-list-t-r-time {
  font-size: 0.414rem;
  line-height: 0.414rem;
}
.coupon-list-fgx {
  height: 0;
  border-top: 0.077625rem dashed #fff;
  margin: 0 0.439875rem;
}
.coupon-list-btn {
  width: 5.01975rem;
  height: 1.216125rem;
  line-height: 1.216125rem;
  font-size: 0.5175rem;
  color: #ff4e47;
  background-color: #fde8e8;
  border-radius: 1.216125rem;
  margin: 0.284625rem auto;
  text-align: center;
}
.goShopModule .custom-store-img {
  position: absolute;
  top: 0.284625rem;
  left: 0.46575rem;
  height: 0.46575rem;
  ...
  background: url(data:image/png;base64,)
    no-repeat;
  background-size: 0.46575rem 0.46575rem;
}
.goShopModule .custom-store-name {
  float: left;
  padding: 0 0 0 0.98325rem;
  height: 0.56925rem;
  line-height: 0.56925rem;
  font-size: 0.36225rem;
  color: #333;
...
.goShopModule .custom-store-enter {
  float: right;
  height: 0.36225rem;
  line-height: 0.36225rem;
  margin: 0.1035rem 0;
...
.goShopModule a:after {
  ...
  width: 0.181125rem;
  height: 0.181125rem;
  border-top: 0.05175rem solid #cbc9cc;
  border-right: 0.05175rem solid #cbc9cc;
...
.groupingDirective .add-grouping {
  border: 0.025875rem solid #bfcbd9;
  margin: 0 0.25875rem;
  padding: 0.36225rem;
  background: #fff;
  zoom: 1;
...
.groupingDirective .grouping-sources {
  position: relative;
}
.groupingDirective .grouping-source {
  border: 0.025875rem solid #bfcbd9;
  margin: 0 0.25875rem;
  padding: 0.36225rem;
  background: #fff;
...
.groupingDirective .grouping-source .text {
  display: inline-block;
  width: 7.943625rem;
  color: blue;
}
.groupingDirective .grouping-source .btn {
  color: #20a0ff;
  cursor: pointer;
}
.groupingDirective .grouping-sources:hover .actions {
  display: block;
}
.grouping-sources .actions {
  position: absolute;
  top: -0.25875rem;
  right: -0.077625rem;
  display: none;
}
.control-group:hover .help-desc {
  opacity: 1;
}
.help-desc {
  opacity: 0.6;
...
.grouping-topNav {
  ...
  background-color: #fff;
  overflow: visible;
  border-top: 0.025875rem solid #e5e5e5;
  border-bottom: 0.025875rem solid #e5e5e5;
}
.guideModule {
  padding: 0.46575rem 0;
}
.guideModule .bor {
  height: 0;
  border-top-width: 0.025875rem;
}
.goShopDirective input[type="text"] {
  width: 8.7975rem;
  font-size: 0.3105rem;
}
.noticeNavModule .custom-notice {
  padding-left: 0.25875rem;
  height: 0.957375rem;
  line-height: 0.957375rem;
  color: #f90;
  background: #ffc;
  border-top: 0.025875rem solid #f2f2f2;
  border-bottom: 0.025875rem solid #f2f2f2;
  font-size: 0.3105rem;
  overflow: hidden;
}
.noticeNavModule .custom-notice > span {
  float: left;
}
.noticeNavModule .custom-notice .noticeNav-text {
  width: 7.29675rem;
  overflow: hidden;
  white-space: nowrap;
}
...
.picNavModule ul:after,
.picNavModule ul:before {
  display: table;
  line-height: 0;
  content: "";
}
...
.picNavModule li a {
  display: block;
  padding: 0 0.05175rem;
}
.picNavModule li span {
  display: block;
  overflow: hidden;
  position: relative;
}
.picNavModule li span.title {
  color: #333;
  height: 0.621rem;
  line-height: 0.621rem;
  font-size: 0.3105rem;
...
.picNavModule img:before {
  position: absolute;
  display: block;
  content: "";
  top: -0.181125rem;
  left: -0.181125rem;
  height: calc(100% + 0.25875rem);
  width: calc(100% + 0.25875rem);
  background-color: #e6e6e6;
  border: 0.05175rem dotted #c8c8c8;
  border-radius: 0.129375rem;
}
.picNavModule img:after {
  position: absolute;
  display: block;
  content: "(>_<)";
  top: 50%;
...
.richTextModule .custom-richtext {
  padding: 0 0.25875rem;
  padding-top: 0.25875rem;
  box-sizing: border-box;
  font-size: 0.414rem;
  color: #333;
  line-height: 1.5;
...
.richTextModule .custom-richtext img + br {
  display: block;
  padding: 0.1035rem 0;
  content: " ";
}
.richTextModule .custom-richtext p {
  margin: 0 0 1em;
}
.richTextModule .custom-richtext .Powered-by-XIUMI p {
  margin: 0;
}
.richTextModule .custom-richtext a {
  color: #07d;
}
.richTextModule .custom-richtext img {
  background: none;
  max-width: 100% !important;
  min-height: 0.025875rem;
  width: auto !important;
  vertical-align: bottom;
}
.richTextModule .custom-richtext ol,
.richTextModule .custom-richtext ul {
...
.richTextModule .custom-richtext blockquote {
  padding: 0 0 0 0.388125rem;
  margin: 0 0 0.46575rem;
  border-left: 0.129375rem solid #eee;
}
.richTextModule .custom-richtext em,
.richTextModule .custom-richtext i {
  font-style: italic;
}
.richTextModule .custom-richtext b,
.richTextModule .custom-richtext strong {
  font-weight: 700;
}
.richTextModule .custom-richtext .selectTdClass {
  background-color: #edf5fa !important;
}
.richTextModule .custom-richtext table.noBorderTable caption,
.richTextModule .custom-richtext table.noBorderTable td,
.richTextModule .custom-richtext table.noBorderTable th {
  border: 0.025875rem dashed #ddd !important;
}
.richTextModule .custom-richtext table {
  margin-bottom: 0.25875rem;
  border-collapse: collapse;
  display: table;
  width: auto !important;
}
.richTextModule .custom-richtext td,
.richTextModule .custom-richtext th {
  padding: 0.129375rem 0.25875rem;
  border: 0.025875rem solid #ddd;
}
.richTextModule .custom-richtext caption {
  border: 0.025875rem dashed #ddd;
  border-bottom: 0;
  padding: 0.077625rem;
  text-align: center;
}
.richTextModule .custom-richtext th {
  border-top: 0.05175rem solid #bbb;
  background: #f7f7f7;
}
.richTextModule .custom-richtext .ue-table-interlace-color-single {
  background-color: #fcfcfc;
}
.richTextModule .custom-richtext .ue-table-interlace-color-double {
  background-color: #f7faff;
}
.richTextModule .custom-richtext td p {
  margin: 0;
  padding: 0;
}
.richTextModule .custom-richtext .bottom-floating-banner {
...
.textNavModule .list {
  ...
  font-weight: 700;
  height: 1.1385rem;
  border-bottom: 0.025875rem solid #e6e6e6;
}
.textNavModule .list i {
  background: url(data:image/png;base64,)
    no-repeat scroll 0 0;
  background-size: 0.388125rem 0.77625rem;
  display: inline-block;
  width: 0.388125rem;
  height: 0.388125rem;
  margin-top: 0.388125rem;
  vertical-align: top;
}
.textNavModule .list span {
  overflow: hidden;
  display: inline-block;
  width: 7.245rem;
  white-space: nowrap;
...
.titleModule .sub_title {
  color: #8c8c8c;
  font-size: 0.284625rem;
  margin: 0.129375rem 0 0;
}
.titleModule .custom-title-link {
  margin-left: 0.25875rem;
}
.titleModule .custom-title-link-container a {
  font-size: 0.3105rem;
  color: #07d;
}
.titleModule .sub_title_author,
.titleModule .sub_title_date,
.titleModule .sub_title_link {
  margin-right: 0.25875rem;
}
.titleModule .sub_title_link {
  color: #6191bf;
...
.windowModule .windowModule-wrap-title {
  padding: 0.25875rem;
  font-size: 0.36225rem;
}
.windowModule .windowModule-body-title {
  font-size: 0.36225rem;
  font-weight: 700;
  padding: 0 0.25875rem;
  box-sizing: border-box;
...
.windowModule .windowModule-body-desc {
  padding: 0 0.25875rem;
  box-sizing: border-box;
  margin: 0;
  padding-bottom: 0.25875rem;
...
.windowModule-pic > div {
  float: left;
  text-align: center;
  box-sizing: border-box;
  overflow: hidden;
}
.borNo .windowModule-pic-left {
  width: 5.511375rem;
  height: 5.53725rem;
  margin: 0;
}
.borNo .windowModule-pic-right > div {
  width: 2.768625rem;
  height: 2.768625rem;
  margin: 0;
}
.borNo .windowModule-pic.way02 .windowModule-pic-center.bg-cover {
  margin: 0;
  width: 2.7945rem;
}
.windowModule-pic-left {
  width: 5.511375rem;
  height: 5.511375rem;
  margin: 0 0.025875rem 0 0;
}
.windowModule-pic-right > div {
  width: 2.74275rem;
  height: 2.74275rem;
  margin: 0 0 0.025875rem;
}
.windowModule-pic-center {
  margin: 0 0.025875rem;
}
.windowModule-pic.way02 .bg-cover {
  width: 2.74275rem;
  height: 2.74275rem;
}
body,
...
textarea {
  background-color: #fff;
  border: 0.025875rem solid #ccc;
  box-shadow: inset 0 0.025875rem 0.025875rem rgba(0, 0, 0, 0.075);
  transition: border 0.2s linear, box-shadow 0.2s linear;
  display: inline-block;
  height: 0.5175rem;
  padding: 0.1035rem 0.15525rem;
  font-size: 0.36225rem;
  line-height: 0.5175rem;
  color: #555;
  vertical-align: middle;
